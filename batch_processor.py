            ...
            if os.path.exists(image_csv):
                ...
                def img_html(path):
                    ...
                    try:
                        ...
                        # For batch processing, the images need to be embedded
                        ...
                        if not os.path.exists(full_path):
                            # Try looking for the file in the batch results
                            filename = os.path.basename(path)
                            for component_type in ['Cable', 'Port', 'Rack', 'Switch']:
                                test_path = os.path.join(image_result_dir, component_type, filename)
